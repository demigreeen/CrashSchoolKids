...
public class MovePlayer : MonoBehaviour
{
    ...
    public void Move()
    {
       ...
       // rb.velocity = new Vector3(_moveDir.x * currentSpeed * Time.fixedDeltaTime * 100, rb.velocity.y, _moveDir.z * currentSpeed * Time.fixedDeltaTime * 100);
        rb.MovePosition( rb.transform.position + _moveDir * currentSpeed * Time.fixedDeltaTime);
    }
