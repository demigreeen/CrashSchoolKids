...
{
    public  event Action dragItemEvent;
    ...
    [SerializeField] private GameObject iconToExit;
        ...
        if(!TimeBeforeAdverstiment.isAd)
        {
            ...
            else if (isHandsEmpty == false)
            {
                ...
                if(holdItem != null)
                {
                    ...
                    if (holdItem.transform.tag == "Ball")
                    {
                        if(transform.position.z < 40.6f)
                        {
                            if (YG2.envir.isMobile == false)
                                iconToExit.SetActive(false);
            ...
            if (nearestItem != null && nearestItem.transform.tag !="Ball")
            {
    ...
    public void CheckInput()
    {
        ...
        {
            if (isHandsEmpty == true && nearestItem != null  && timeOffsetCode >= timeOffset || isHandsEmpty == true && nearestItem != null && nearestItem.transform.tag == "Ball")
            {
                if (RBDeviceType.MyIsMobile() == false)
                    iconToExit.SetActive(true);

                isMobileTap = false;
                mobileIcon.SetActive(true);
                dragItemEvent?.Invoke();
    ...
    void Drop()
    {
        if (ItemDroped != null && nearestItem.transform.tag != "Ball")
        {
        ...
        if (nearestItem.transform.tag == "Ball")
        {
            float force = forceDrop;
            forceDrop = forceDrop * 3;
    ...
    public void CheckDistanceToItems()
    {
